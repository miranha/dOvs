    ...
    let
        ...
        and doStm (T.SEQ(a, b)) =
          ...
          | doStm (T.CJUMP(p,a,b,t,f)) = 
            reorderStm ([a,b], fn [a,b] => T.CJUMP(p,a,b,t,f))
          ...
          | doStm (T.MOVE(T.MEM e,b)) =
            reorderStm ([e,b], fn [e,b] => T.MOVE(T.MEM e,b))
        ...
        and doExp (T.BINOP(p,a,b)) = 
            reorderExp ([a,b], fn [a,b] => T.BINOP(p,a,b))
          | doExp (T.MEM a) =
	    reorderExp ([a], fn [a] => T.MEM a)
          | doExp (T.ESEQ(s,e)) =
